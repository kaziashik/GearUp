...
import { User, Mail, Phone, MapPin, Calendar, Loader2, Save, Camera, Shield } from "lucide-react";
  ...
  return (
    <div className="space-y-6 animate-fade-in max-w-2xl">
      <div>
        ...
        <p className="text-muted-foreground">Manage your administrative account</p>
      </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <div className="px-2 py-0.5 rounded-md bg-primary/20 text-primary text-xs font-semibold">
                ADMIN
              </div>
            </div>
